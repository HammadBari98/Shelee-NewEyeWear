...
<head>
    ...
    <title>New View Eyewear | Lenses</title>
    <meta name="keywords" content="HTML5 Template">
    <meta name="description" content="New View Eyewear">
...
?>
                ...
                <div class="col-12 col-md-9 col-sm-12 col-lg-9">
                    ...
                    $selectquery = "Select * from lense_table where category_name='$category_name'";
                    $query = mysqli_query($mysqli,$selectquery);
                    $nums = mysqli_num_rows($query);
                    while($res=mysqli_fetch_array($query)){
                        ...
                        ?>
                                            <div class="col-12 col-md-2 col-sm-12 col-lg-2 colmn"
                                                ...
                                                if(isset($_SESSION['login_user'])){
                                                    ?>
                                                    <a href="productLense.php?id=<?php echo $res['lense_id'] ?>&customer_id=<?php echo $_SESSION['login_id']; ?> ">
                                                    <?php
                                                }
                                                else {
                                                    ?>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="widget widget-about">
                                <img src="assets/images/logo-new.png" class="footer-logo" alt="Footer Logo" width="105"
                                    height="25">
                                <p style="color: white;"> New View Eyewear has emerged as a household name when
