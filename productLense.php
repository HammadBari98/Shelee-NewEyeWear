...
<head>
    ...
    <title>New View Eyewear Shop | Product</title>
        ...
        <main class="main">
            ...
            <div class="page-content">
                <div class="container">
                    ...
                    $lense_id=$_GET['id'];
                    $selectquery = "Select * from lense_table where lense_id=$lense_id";
                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        ...
                                        <div id="product-zoom-gallery" class="product-image-gallery">
                                            <a class="product-gallery-item active" href="#" data-image="<?php echo 'sheleeAdminpanel/images/' . $res['image1'] ?>" data-zoom-image="<?php echo 'sheleeAdminpanel/images/' . $res['image1'] ?>">
                                                <img src="<?php echo 'sheleeAdminpanel/images/' . $res['image1'] ?>" alt="product side">
                                            </a>

                                            <a class="product-gallery-item" href="#" data-image="<?php echo 'sheleeAdminpanel/images/' . $res['image2'] ?>"data-zoom-image="<?php echo 'sheleeAdminpanel/images/' . $res['image2'] ?>">
                                                <img src="<?php echo 'sheleeAdminpanel/images/' . $res['image2'] ?>" alt="product cross">
                                            </a>

                                            <a class="product-gallery-item" href="#" data-image="<?php echo 'sheleeAdminpanel/images/' . $res['image3'] ?>"data-zoom-image="<?php echo 'sheleeAdminpanel/images/' . $res['image3'] ?>">
                                                <img src="<?php echo 'sheleeAdminpanel/images/' . $res['image3'] ?>" alt="product with model">
                                            </a>
                    ...
                    ?>
                                <div class="product-details">
                                    <h1 class="product-title"><?php echo $res['lense_name'] ?></h1><!-- End .product-title -->
                                    ...
                                    <a href="shop-page.php?lense_id=<?php echo $lense_id ?>">
                                    ...
                                    <!-- <div class="product-details-action">
                                        <a href="shop-page.php" class="btn-product btn-cart"><span>add to cart</span></a>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["add_to_cart"])) {
    ...
    $glass_id=$res['lense_id'];
    $glassName = $res['lense_name'];
...
?>
                    ...
                    <div class="product-details-tab">
                        <ul class="nav nav-pills justify-content-center" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="product-desc-link" data-toggle="tab" href="#product-desc-tab" role="tab" aria-controls="product-desc-tab" aria-selected="true"style="color: #12b48b;">Description</a>
                            </li>
                            <li class="nav-item">
