...
<body>
    <div class="page-wrapper">
        ...
        <main class="main">
            <h3 style="text-align: center;"><a href="frames-offer.php"><button class="btn btn-success"
                        style="background-color: #12b48b;"> Glasses</button></a> <button class="btn btn-default">
                    Lens</button></h3>
 ...
 $selectquery = "SELECT DISTINCT category_name,quantity FROM lense_table;";
 ...
 ?>
                                    <ul class="submenu">
                                        <li><a
                                                href="categoryLense.php?category_name=<?php echo $res['category_name'] ?>"><?php echo $res['category_name'] ?>
                                            </a>
                                            <!-- <span class="jquery-accordion-menu-label"><?php echo $res['quantity'] ?>
                                            </span> -->
                                        </li>
                                    </ul>
                                    <?php
    ...
    ?>
                                ...
                                <li><a href="#" style="display: flex;"><img src="images/icons/mozy.png"
                                    ...
                                    <?php
 include('connection.php');
 $selectquery = "SELECT DISTINCT color FROM lense_table;";
 $query = mysqli_query($mysqli,$selectquery);
 $nums = mysqli_num_rows($query);
 ...
 ?>
                                    <ul class="submenu">
                                        <li><a href="colorLense.php?color_name=<?php echo $res['color'] ?> "><?php echo $res['color'] ?>
    ...
    ?>
                                ...
                                <li style="border-bottom: 1px solid black;"><a href="#" style="display: flex;"><img
                                    ...
                                    <?php
 include('connection.php');
 $selectquery = "SELECT DISTINCT brand FROM lense_table;";
 $query = mysqli_query($mysqli,$selectquery);
 $nums = mysqli_num_rows($query);
 ...
 ?>
                                    <ul class="submenu">
                                        <li><a href="brandLense.php?brand_name=<?php echo $res['brand'] ?>"><?php echo $res['brand'] ?>
                                            </a><span class="jquery-accordion-menu-label">
                                            </span>
                                        </li>
                                    </ul>
                                ...
                                <table class="table table-striped  b-t" id="mytable">
                                    ...
                                    <tbody>
                                        <tr>
                                            <?php
                    include('connection.php');
                    $selectquery = "Select * from lense_table";
                    $query = mysqli_query($mysqli,$selectquery);
                    $nums = mysqli_num_rows($query);
                    while($res=mysqli_fetch_array($query)){
                        ...
                        ?>
                                            <div class="col-12 col-md-2 col-sm-12 col-lg-2 colmn"
                                                style="border:1px solid black;  margin-left:20px; height:300px">
                                                <?php   
                                                if(isset($_SESSION['login_user'])){
                                                    ?>
                                                <a
                                                    href="productLense.php?id=<?php echo $res['lense_id'] ?>&customer_id=<?php echo $_SESSION['login_id']; ?> ">
                                                    <?php
                                                }
                                                else {
                                                    ?>

                                                    <a href="productLense.php?id=<?php echo $res['lense_id'] ?> ">
                                                        <?php
                                                }
                                                ?>
                                                        <a href="productLense.php?id=<?php echo $res['lense_id'] ?>">
                                                            <center>
                                                                <div class="card1">
                                                                    ...
                                                                    <img src="<?php echo 'sheleeAdminpanel/images/' . $res['image2'] ?>"
                                                                        class="img-top1" alt="Card Front" height="150px"
                                                                        width="150px">
                                                                </div>
                                                            </center>
