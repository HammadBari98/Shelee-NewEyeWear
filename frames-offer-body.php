   ...
   <div class="row"style="padding:10px;">
       <div class="col-12 col-md-2" >
        <div class="content">
			...
			<div id="jquery-accordion-menu" class="jquery-accordion-menu">
				<ul>
					<li style="border-top: 1px solid black;"><a href="#"><i class="fa fa-cog"></i>Category </a>
						<ul class="submenu">
                    ...
                    <li><a href="#"><i class="fa fa-suitcase"></i>Shape </a>
						<ul class="submenu">
                    ...
                    <li style="border-bottom: 1px solid black;"><a href="#"><i class="fa fa-suitcase"></i>Brands </a>
						<ul class="submenu">
							<li><a href="lenses.php">Web Design </a></li>
							<li><a href="#">Graphics </a><span class="jquery-accordion-menu-label">10 </span></li>
							<li><a href="#">Photoshop </a></li>
							<li><a href="#">Programming </a></li>
						</ul>
       ...
       <div class="col-12 col-md-10">
           ...
           <div class="row" > 
               ...
               <h3 style="text-align: center;"><p></p> Glasses |  Lens</a></h3>  
               <div class="col-12 col-md-4"style="box-shadow: 0 4px 4px -2px gray;">
                <a href="/lenses.php"> 
                <div class="card">
                    
                    <img src="pub/media/catalog/product/cache/5ab4f864193b307df280efcc385516ca/e/1/e1391b1a1_1_lar.jpg" alt="Card Back">
                    <img src="pub/media/catalog/product/cache/5ab4f864193b307df280efcc385516ca/e/1/e1399a1a1_1_lar.jpg" class="img-top" alt="Card Front">
                </div>
                </a>
                <h4 style="text-align: center; color: grey;">Black Rectangle Rimmed Eyeglasses from Titan</h4>
                <br>
               ...
               <div class="col-12 col-md-4"style="box-shadow: 0 4px 4px -2px gray;">
                <div class="card">
                    ...
                    <img src="pub/media/catalog/product/cache/5ab4f864193b307df280efcc385516ca/f/t/ft1053a1a1_1_lar.jpg" alt="Card Back">
                    <img src="pub/media/catalog/product/cache/5ab4f864193b307df280efcc385516ca/f/t/ft1076wfc4_1_lar.jpg" class="img-top" alt="Card Front">
                </div>
                <h4 style="text-align: center; color: grey;">Black Rectangle Semi-Rimmed Eyeglasses from Titan</h4>
                <br>
                <h4 style="text-align: center; color: grey;"><s>₹599.00</s> ₹480.00</h4>
               ...
               <div class="col-12 col-md-4"style="box-shadow: 0 4px 4px -2px gray;">
                <div class="card">
                    ...
                    <img src="pub/media/catalog/product/cache/5ab4f864193b307df280efcc385516ca/t/w/tw1080mfp1_1_lar.jpg" alt="Card Back">
                    <img src="pub/media/catalog/product/cache/5ab4f864193b307df280efcc385516ca/t/w/tw1080mfp1_3_lar.jpg" class="img-top" alt="Card Front">
                </div>
                <h4 style="text-align: center; color: grey;">Black Rectangle Rimless Eyeglasses from Titan
                </h4>
                <br>
                <h4 style="text-align: center; color: grey;"><s>₹599.00</s> ₹480.00</h4>
