...
<!-- 
                ...
                <input type="text" style="color:black;" id="myInput" onkeyup="myFunction()" placeholder="Search for New View Eyewear" title="Type in a name">
            </div>
