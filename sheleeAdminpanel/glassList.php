            ...
            <div ui-view class="app-body" id="view">
                ...
                <div class="padding ">
                    ...
                    <a>Category</a>
                        ...
                        <div class="row p-a">
                            <div class="col-sm-12">
                                <a class="btn btn-fw primary" href="addGlasses.php">
                                <i>&#xe02e;</i>
                                &nbsp; Add New Glass
                            </a>
                            </div>
                ...
                <input type="text" style="color:black;" id="myInput" onkeyup="myFunction()" placeholder="Search Glass Here" title="Type in a name">
            </div>
                            ...
                            <table class="table table-striped  b-t" id="mytable">
                                ...
                                <?php
                                    include('connection.php');
                                        $selectquery = "Select * from glasses_table";
                                        ...
                                        while($res=mysqli_fetch_array($query)){
                                            ...
                                            <td><?php echo $res['glass_name'] ?></td>
                                            <td><?php echo $res['short_description'] ?></td>
                                            <td><?php echo $res['long_description'] ?></td>
                                            ...
                                            <td><?php echo $res['image3'] ?></td>  
                                            <td><?php echo $res['date'] ?></td>
                                            <td><?php echo $res['time'] ?></td>
                                          


                                           <td >  <center>  <a href="updateGlass.php?id=<?php echo $res['glass_id'] ?>"> <i style="font-size: 18px;" class="fa fa-pencil-square-o" aria-hidden="true" ></i></a></center></td>
                                           <td >  <center> <a href="deleteGlass.php?id=<?php echo $res['glass_id'] ?>"> <i style="font-size: 18px;" class="fa fa-trash" aria-hidden="true" ></i></center></td>
