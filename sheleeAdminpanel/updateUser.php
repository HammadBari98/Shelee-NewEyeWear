...
$password=mysqli_real_escape_string($mysqli,$_POST['password']);
   ...
   $updateQuery=" update users set user_id=$id,username='$username',user_password='$password' where user_id=$id";
...
?>
                                <div class="form-group">
                                    ...
                                    <div class="row col-md-6">
                                        ...
                                        <input name="username" value="<?php echo $res['username'] ?>" class="form-control" placeholder="Enter Lense Name">
                                    ...
                                    <div class="row col-md-6">
                                        ...
                                        <input name="password" value="<?php echo $res['user_password'] ?>" class="form-control"
