                ...
                <div class="padding">
                    <div class="box">
                        <div class="box-header dker">
                            <h3><i class="material-icons">&#xe3c9;</i> Edit Admin
                            </h3>
                            <small>
                    ...
                    <a href="">Admin &amp; Permissions</a>
                        ...
                        <div class="box-body">
                            <form method="POST" action="" accept-charset="UTF-8" enctype="multipart/form-data"><input name="_token" type="hidden" value="8B3YjHlHA92n9KTfOZDOhQrjpmWGGgK0aK5fh3W7">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div id="user_photo" class="col-sm-4 box p-a-xs">
                                                    <a target="_blank" href="uploads/users/15791701775245.jpg"><img
                                                    src="uploads/users/15791701775245.jpg"
                            ...
                            Extensions: .png, .jpg, .jpeg, .gif
                                ...
                                &#xe31b;</i> Save Changes</button>
                                        <a href="#" class="btn btn-default m-t"><i class="material-icons">
                                &#xe5cd;</i> Cancel</a>
                                    </div>
                                </div>
        ...
        <div id="switcher">
            ...
            <i class="fa fa-gear"></i>
                ...
                <div class="box-body">
                    ...
                    <form method="POST" action="lang" accept-charset="UTF-8"><input name="_token" type="hidden" value="8B3YjHlHA92n9KTfOZDOhQrjpmWGGgK0aK5fh3W7">
