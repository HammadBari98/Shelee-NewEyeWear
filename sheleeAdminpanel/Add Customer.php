...
<div class="row col-md-6">
      ...
      <input type="email" class="form-control" id="email" placeholder="Customer Name" name="email">
    </div>
</div>
</br>
</br>
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="pwd" placeholder="Enter Address" name="pswd">
    </div>
</div>
</br>
</br>
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" id="pwd" placeholder="Enter Contact" name="pswd">
    </div>
</div>
</br>
</br>
