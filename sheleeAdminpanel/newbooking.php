            ...
            <i class="material-icons">&#xe5d2;</i>
                  ...
                  <span class="avatar w-32">
                    ...
                    <div class="collapse navbar-toggleable-sm" id="collapse">
                        <form method="POST" action="admin/find" accept-charset="UTF-8" role="search" class="navbar-form form-inline pull-right pull-none-sm navbar-item v-m"><input name="_token" type="hidden" value="phXc8IdicjP9ZCgZHd8S3W5gEe91osmqrXfgWTvM">
...
<div class="row col-md-6">
      ...
      <select name="cars" class="form-control " >
                                        ...
                                        <option value="volvo">cylinder</option>
    <option value="saab">axis </option>
    <option value="opel">add</option>
    <option value="opel">power</option> 
</select>   </div>
</div>
</br>
</br>
