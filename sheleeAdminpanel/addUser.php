                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="row col-md-6">
                                        ...
                                        <input name="username" class="form-control" placeholder="Enter Lense Name">
                                    ...
                                    <button name="addUser" class="btn btn success">Add User</button>
                        </form>
                    </div>
                </div>
                <div class="row">
...
if (isset($_POST['addUser'])) {
    ...
    $insertQuery = "INSERT INTO users (username,user_password)
