                ...
                <div class="navbar">
                    ...
                    <div class="collapse navbar-toggleable-sm" id="collapse">
                        <form method="POST" action="#" enctype="multipart/form-data" accept-charset="UTF-8"
                            role="search" class="navbar-form form-inline pull-right pull-none-sm navbar-item v-m">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="row col-md-6">
                                    ...
                                    <input name="glassname" class="form-control" placeholder="Enter Glass Name">
                                ...
                                <div class="row col-md-6">
                                    ...
                                    <input name="shortdescription" class="form-control" placeholder="Short Discription">
                                ...
                                <div class="form-group">
                                    <div class="row col-md-6">
                                        ...
                                        <input name="image1" type="file" />      </div>
                                </div>
                                </br>
                                </br>
                                </br>
                                ...
                                <div class="form-group">
                                    <div class="row col-md-6">
                                        ...
                                        <input name="image2" type="file"  />     </div>
                                </div>
                                </br>
                                </br>
                                </br>
                                ...
                                <div class="form-group">
                                    <div class="row col-md-6">
                                        ...
                                        <input name="image3" type="file"  />      </div>
                                </div>
                                </br>
                                </br>
                                </br>
                                ...
                                <button name="insertglass" class="btn btn success">Add Glass</button>
                    </form>
                </div>
...
if (isset($_POST['insertglass'])) {
    ...
    $insertQuery = "INSERT INTO glasses_table (glass_name,short_description,long_description,category_name,color,brand,quantity,purchase_price,sell_price,image1,image2,image3)
values ('$glassName','$shortDescription','$longDescription','$categoryName','$color','$brand',$quantity,$purchasePrice,$salePrice,'$image','$image1','$image2')";
    ...
    ?>
          <script>
            alert('Inserted Glasses Successfully');
        </script>
    <?php
