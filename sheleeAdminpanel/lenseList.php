            ...
            <div ui-view class="app-body" id="view">
                ...
                <div class="padding ">
                    ...
                    <a>Category</a>
                        ...
                        <div class="row p-a">
                            <div class="col-sm-12">
                                <a class="btn btn-fw primary" href="addLense.php">
                                <i>&#xe02e;</i>
                                &nbsp; Add New Lense
                            </a>
                            </div>
                ...
                <input type="text" style="color:black;" id="myInput" onkeyup="myFunction()" placeholder="Search Lense Here" title="Type in a name">
            </div>
                                ...
                                <?php
                                    include('connection.php');
                                        ...
                                        while($res=mysqli_fetch_array($query)){
                                           ...
                                           <td >  <center>  <a href="updateLense.php?id=<?php echo $res['lense_id'] ?>"> <i style="font-size: 18px;" class="fa fa-pencil-square-o" aria-hidden="true" ></i></a></center></td>
                                           <td >  <center> <a href="deleteLense.php?id=<?php echo $res['lense_id'] ?>"> <i style="font-size: 18px;" class="fa fa-trash" aria-hidden="true" ></i></center></td>
