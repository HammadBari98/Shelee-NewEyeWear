...
$id=$_GET['id'];
$selectQuery="select * from lense_table where lense_id=$id";
$query= mysqli_query($mysqli,$selectQuery);
    $res=mysqli_fetch_assoc($query);
if(isset($_POST['updateLense'])){
    // $id=$_GET[$id];
$lenseName=mysqli_real_escape_string($mysqli,$_POST['lensename']);
...
$updateQuery=" update lense_table set lense_id=$id,lense_name='$lenseName',short_description='$shortDescription',long_description='$longDescription',category_name='$categoryName',color='$color',brand='$brand',quantity=$quantity,purchase_price=$purchasePrice,sell_price=$sell_price where lense_id=$id";
...
if ($query) {
    ?>
                                <script>
                                alert('Updated Lense Successfully');
                                </script>
                                <?php  
...
?>
                            <div class="form-group">
                                ...
                                <div class="row col-md-6">
                                    ...
                                    <input name="lensename"  value="<?php echo $res['lense_name'] ?>" class="form-control" placeholder="Enter Glass Name">
                                ...
                                <button name="updateLense" class="btn btn success">Update Lense</button>
                    </form>
                </div>
